This script generates embeddings of various sizes (`368, 512, 768`) for the [WikiAnswers](https://huggingface.co/datasets/embedding-data/WikiAnswers) dataset and publishes them to HuggingFace.
